    ...
    >
      ...
      <main class="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        {:else}
          {#if showAddForm}
            <div
              class="p-4 bg-teren-surface border border-teren-border rounded-xl mb-6 shadow-sm"
            >
          ...
          {#if expenses.length > 0}
            {#each grouped as [slug, items] (slug)}
              <section
                class="border-b border-teren-border/50 last:border-0 pb-2"
              >
                <button
                  onclick={() => toggleCategory(slug)}
                  class="w-full text-left py-3 flex items-center gap-2 group/header focus:outline-none"
                >
                  <span class="emoji text-xl select-none"
                    >{getCategoryEmoji(slug)}</span
                  >
                  <h3
                      ...
                      {#if editingId === exp.id}
                        ...
                        >
                          ...
                          <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                            <div
                              class="relative flex items-center group sm:col-span-1"
                            >
                              <svg
                        ...
                        >
                          <div class="flex justify-between items-start gap-3">
                            <div class="flex gap-3 flex-1 min-w-0">
                              <!-- Icono con Tooltip -->
                              <span
                                class="emoji text-xl select-none relative group/icon shrink-0"
                              >
                              ...
                              <div class="flex-1 min-w-0">
                                ...
                                >
                                  ...
                                  <span
                                    class="text-xs text-teren-text-muted shrink-0 ml-2"
                                  >
                            ...
                            <button
                              ...
                              class="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 text-error-base/70 hover:text-error-base p-1.5 rounded-lg hover:bg-error-subtle transition active:scale-95 shrink-0"
                              aria-label="Delete"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
