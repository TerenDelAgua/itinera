...
{#if isOpen}
  ...
  >
    ...
    >
      <h3
        class="text-lg font-semibold text-teren-text-main tracking-tight mb-2"
      >
        {title}
      </h3>
      ...
      <div class="flex justify-end gap-3">
        ...
        <button
          class="px-4 py-2 text-sm font-medium text-white rounded-lg transition active:scale-95 shadow-sm {isDestructive
            ? 'bg-red-500 hover:bg-red-600 shadow-red-500/20'
            : 'bg-teren-primary hover:bg-teren-primary-hover shadow-teren-primary/20'}"
          onclick={onConfirm}
        >
          {confirmText}
        </button>
